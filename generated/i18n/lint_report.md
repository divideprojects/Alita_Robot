...
- **warning** `alita/modules/admin.go:661` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/bot_updates.go:18` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`

- **warning** `alita/modules/bot_updates.go:98` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "Reloaded admin cache for %d (%s)"
  - Context: `Reloaded admin cache for %d (%s)`

- **warning** `alita/modules/bot_updates.go:227` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "anonAdmin.%d.%d"
  - Context: `anonAdmin.%d.%d`

- **warning** `alita/modules/captcha.go:21` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`

- **warning** `alita/modules/captcha.go:606` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/captcha.go:633` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "Invalid user ID"
  - Context: `Invalid user ID`

- **warning** `alita/modules/captcha.go:639` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "This captcha is not for you!"
  - Context: `This captcha is not for you!`

- **warning** `alita/modules/captcha.go:652` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/captcha.go:707` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "✅ Verified successfully!"
  - Context: `✅ Verified successfully!`

- **warning** `alita/modules/captcha.go:727` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "muted permanently"
  - Context: `muted permanently`

- **warning** `alita/modules/captcha.go:769` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "Invalid user ID"
  - Context: `Invalid user ID`
...
- **warning** `alita/modules/captcha.go:782` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/captcha.go:793` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "This captcha attempt is no longer valid."
  - Context: `This captcha attempt is no longer valid.`
...
- **warning** `alita/modules/captcha.go:878` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/connections.go:163` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "Connect to chat"
  - Context: `Connect to chat`

- **warning** `alita/modules/devs.go:61` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "<b>Name:</b> %s\n<b>Chat ID</b>: %d\n<b>Users Count:</b> %d\n<b>Link:</b> %s"
  - Context: `<b>Name:</b> %s\n<b>Chat ID</b>: %d\n<b>Users Count:</b> %d\n<b>Link:</b> %s`

- **warning** `alita/modules/disabling.go:16` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`

- **warning** `alita/modules/disabling.go:55` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/greetings.go:21` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`
...
- **warning** `alita/modules/helpers.go:190` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "You have been connected to %s!"
  - Context: `You have been connected to %s!`

- **warning** `alita/modules/helpers.go:235` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/locks.go:19` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`
...
- **warning** `alita/modules/misc.go:107` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "<b>Chat ID:</b> <code>%d</code>\n"
  - Context: `<b>Chat ID:</b> <code>%d</code>\n`

- **warning** `alita/modules/misc.go:138` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/misc.go:164` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "Your ID is <code>%d</code>\nThis group's ID is <code>%d</code>"
  - Context: `Your ID is <code>%d</code>\nThis group's ID is <code>%d</code>`

- **warning** `alita/modules/misc.go:251` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "\nUsername: @%s"
  - Context: `\nUsername: @%s`

- **warning** `alita/modules/misc.go:256` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "<b>User Info:</b>"
  - Context: `<b>User Info:</b>`

- **warning** `alita/modules/misc.go:261` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "\nUsername: @%s"
  - Context: `\nUsername: @%s`

- **warning** `alita/modules/misc.go:263` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "\nUser link: %s"
  - Context: `\nUser link: %s`

- **warning** `alita/modules/mute.go:14` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`
...
- **warning** `alita/modules/notes.go:52` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "Saved Note <b>%s</b>!\nGet it with <code>#%s</code> or <code>/get %s</code>."
  - Context: `Saved Note <b>%s</b>!\nGet it with <code>#%s</code> or <code>/get %s</code>.`

- **warning** `alita/modules/notes.go:284` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/pins.go:163` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/pins.go:174` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "[Pin] UnpinAllChatMessages: %d"
  - Context: `[Pin] UnpinAllChatMessages: %d`

- **warning** `alita/modules/purges.go:20` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`
...
- **warning** `alita/modules/reports.go:19` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`

- **warning** `alita/modules/reports.go:139` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "\n<b> • Reported user:</b> %s"
  - Context: `\n<b> • Reported user:</b> %s`

- **warning** `alita/modules/reports.go:140` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "\n<b>Status:</b> <i>Pending...</i>"
  - Context: `\n<b>Status:</b> <i>Pending...</i>`

- **warning** `alita/modules/reports.go:392` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/rules.go:16` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`
...
- **warning** `alita/modules/warns.go:15` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "github.com/divideprojects/Alita_Robot/alita/utils/chat_status"
  - Context: `github.com/divideprojects/Alita_Robot/alita/utils/chat_status`

- **warning** `alita/modules/warns.go:216` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/warns.go:665` - Hardcoded string that should be internationalized
  - Suggestion: Consider moving to i18n: "rmAllChatWarns.no"
  - Context: `rmAllChatWarns.no`

- **warning** `alita/modules/warns.go:697` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/warns.go:699` - Hardcoded string that should be internationalized
...
- **warning** `alita/modules/warns.go:704` - Hardcoded string that should be internationalized
