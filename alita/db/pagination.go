...
func (mp *MongoPagination[T]) GetNextPage(ctx context.Context, filter bson.M, opts PaginationOptions) (PaginatedResult[T], error) {
...
func (mp *MongoPagination[T]) GetPageByOffset(ctx context.Context, filter bson.M, opts PaginationOptions) (PaginatedResult[T], error) {
	applySafetyLimits(&opts)
