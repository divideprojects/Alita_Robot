...
func registerAllMessages() {
	...
	MustRegister("admin_invite_link_username", "Here is the invite link of this chat: %s", "link")
	MustRegister("admin_invite_link_private", "Here is the invite link of this chat: %s", "link")
	...
	MustRegister("pins_pinned_message_loudly", "I have pinned <a href='%s'>this message</a> loudly!", "link")
	...
	MustRegister("pins_antichannelpin_status_enabled", "Anti-Channel pins are currently <b>enabled</b> in %s. All channel posts that get auto-pinned by telegram will be replaced with the previous pin.", "chat_title")
	MustRegister("pins_antichannelpin_status_disabled", "Anti-Channel pins are currently <b>disabled</b> in %s.", "chat_title")
	...
	MustRegister("pins_here_pinned_message", "<a href='%s'>Here</a> is the pinned message.", "link")
	...
	MustRegister("reports_blocked_user", "Blocked user %s from reporting.", "mention")
	MustRegister("reports_reply_to_block", "You must reply to a user to block them.")
	MustRegister("reports_unblocked_user", "Unblocked user %s from reporting.", "mention")
	...
	MustRegister("reports_resolved_by", "<b>Resolved by:</b> %s", "admin")
	...
	MustRegister("rules_for_chat", "The rules for <b>%s</b> are:", "chat_title")
	...
	MustRegister("misc_ping_result", "Pinged in %d ms", "milliseconds")
	MustRegister("misc_translate_request_error", "Error making a translation request!")
	MustRegister("misc_translate_reading_error", "Reading Error: %s", "error")
	MustRegister("misc_keyboard_removing", "Removing the stuck bot keyboard...")
	MustRegister("misc_stats_total_messages", "Total Messages in %s are: %d", "chat_title", "message_count")
	...
	MustRegister("devs_user_added_sudo", "Added %s to Sudo List!", "user")
	MustRegister("devs_user_already_dev", "User is already Dev!")
	MustRegister("devs_user_added_dev", "Added %s to Dev List!", "user")
	MustRegister("devs_user_not_sudo", "User is not Sudo!")
	MustRegister("devs_user_removed_sudo", "Removed %s from Sudo List!", "user")
	MustRegister("devs_user_not_dev", "User is not Dev!")
	MustRegister("devs_user_removed_dev", "Removed %s from Dev List!", "user")
